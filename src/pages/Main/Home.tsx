  ...
  return (
    <section className="h-screen">
      <DrawerAndNavLayout>
        ...
        <div className="grid grid-cols-1 grid-rows-1 gap-4 rounded-md">   
            <div className="space-y-2">
                ...
                <div className="w-full space-y-5">
                  <Input label="Student Name" value="Angeles R. Tabrilla" crossOrigin={undefined}/>
                  <Input label="Year" value="1st Year" crossOrigin={undefined}/>
                  <Input label="Course" value="BSIT (Bachelor of Science in Information Technology)" crossOrigin={undefined}/>
                  <Input label="Status" value="REGULAR" crossOrigin={undefined}/>
                </div>         
            </div>
        </div>
            ...
            <div className="space-y-2">
              ...
              <div>
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-4 py-2 pl-10">
                    <Avatar
                      variant="circular"
                      alt="tania andrew"
